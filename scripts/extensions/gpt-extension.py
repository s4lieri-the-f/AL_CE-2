...
class GPT:
    def __init__(self, api_token: str, api_ver: str, deepl_token: str, log) -> None:
        ...
        self.models = {"3": "gpt-3.5-turbo",
                  "4": "gpt-4"}

        self.defprompt = "alice"
        self.prompts_dir = os.path.abspath(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', '..', 'assets', 'extensions', 'prompts'))
